...
export default function AdminImportData() {
  ...
  const templates: Record<string, { headers: string; example: string; filename: string }> = {
    ...
    courses: {
      ...
      example: "01418221,โครงสร้างข้อมูล,Data Structures,3,บังคับ,ศิลปศาสตร์และวิทยาศาสตร์,จันทร์,09:00,12:00,TBA",
      filename: "template_courses.csv",
    },
    curriculum: {
      headers: "รหัสวิชา,ชื่อวิชา,หน่วยกิต,ปีหลักสูตร,ปีที่,ภาคเรียน,ประเภท,วันที่เรียน,เวลาเริ่ม,เวลาสิ้นสุด,ห้องเรียน",
      example: "01418221,โครงสร้างข้อมูล,3,2565,2,1,บังคับ,จันทร์,09:00,12:00,TBA",
